...
const BoldNavLink: FC<{ to: string }> = ({to, children}) => {
    return <NavLink to={to} prefetch="intent"
    ...
    return (
        <div style={{display: "inline-flex", marginLeft: "8px", verticalAlign: "middle"}}>
            <a href="https://twitter.com/na2hiro?ref_src=twsrc%5Etfw" className="twitter-follow-button"
               data-size="large" data-show-count="false" style={{display: "none"}}>Follow @na2hiro</a>
...
export default function App() {
    return (
        ...
        <body>
        <h1><NavLink prefetch="intent" to="/" className={({isActive}) => isActive ? "" : "with-icon"}>About
            na2hiro</NavLink>
            <TwitterFollow/>
        </h1>
